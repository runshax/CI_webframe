                    ...
                    <nav class="navbar navbar-inverse navbar-static-top">
                        <div class="container-fluid">
                            ...
                            <div class="topnav">
                                ...
                                <div class="btn-group">
                                    <a href="<?php echo base_url();?>welcome/logoutapps" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom"
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <!--<ul class="nav navbar-nav">
                                    <li><a href="dashboard.html">Dashboardxxxx</a></li>
                        ...
                        <div class="media user-media bg-dark dker">
                            ...
                            <div class="user-wrapper bg-dark">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><?php echo $this->session->userdata('user_id');?></h5>
                                    <ul class="list-unstyled user-info">
                                        <li><a href=""><?php echo $this->session->userdata('user_group');?></a></li>
                                        <li>Last Access : <br>
...
//                                                                                        </a>
                                                                                    //print_R($sidebar);
												$lvl1 = $sidebar[$i];
												echo "<li id=\"" . $lvl1['menu_name'] . "\" class=\"\">";
												echo "<a href=\"" . site_url($lvl1['url']) . "\"> <i class=\"fa fa-building \"></i><span class=\"link-title\"> ".$lvl1['menu_name']."</span>";
												if(isset($lvl1['sub']) && count($lvl1['sub']) > 0 ) {
														echo "<span class='fa arrow'></span></a>";
														echo "<ul class=\"collapse\">";
														for($j=0; $j<count($lvl1['sub']); $j++) {
																$lvl2 = $lvl1['sub'][$j];		        		
...
//                                                                                                                                              </li>
																...
																echo "<li id=\"" . $lvl2['menu_name'] . "\"><a href=\"" . site_url($lvl2['url']) . "\"><i class=\"fa fa-angle-right\"></i> " . $lvl2['menu_name'];
																		if(isset($lvl2['sub']) && count($lvl2['sub']) > 0) {
																				echo "<span class='fa arrow'></span></a>";
																				echo "<ul class=\"collapse\">";
																				for($k=0; $k<count($lvl2['sub']); $k++) {
																						$lvl3 = $lvl2['sub'][$k];	
																						echo "<li id=\"" . $lvl3['menu_name'] . "\"><a href=\"" . site_url($lvl3['url']) . "\"><i class=\"fa fa-circle-o text-aqua\"></i>" . $lvl3['menu_name'] . "</a></li>";
																				}
																				echo "</ul>";
																		} else {
																				echo "</a>";
										...
										Something unexpected happened when loading the menu library. Please contact your administrator or IT Department.
				<?php } ?>
